...
public class GridViewSupplyAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private ArrayList<Uri> mUri;
    private Context mContext;

    public GridViewSupplyAdapter(Context mContext, ArrayList<Uri> mUri) {
        this.mUri = mUri;
